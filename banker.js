...
var req = [];
 ...
 R=num;
	...
	inp.setAttribute("style","width: 50px;float:left;margin-right:30px; border-radius: 20px;  border: 2px solid red; padding:10px;  width: 40px;  height: 10px;");
 ...
 var input=document.getElementById("inputsection");
	...
	inp1.setAttribute("style","width: 50px;float:left;margin-right:30px; border-radius: 20px;  border: 2px solid red; padding:10px;  width: 40px;  height: 10px;");
	...
	inp2.setAttribute("style","width: 50px;float:left;margin-right:30px; border-radius: 20px;  border: 2px solid red; padding:10px;  width: 40px;  height: 10px;");
	...
	but.setAttribute("style","border-radius: 20px; background: #DC143C;	font-family: Segoe UI;font-size: 1.2vw; color:white;width: 170px;");
...
function banker(){
 ...
 var p3 = document.createElement("input");
	...
	but.setAttribute("style","width:100px; text-align:center; margin:auto; float:left; border-radius: 20px; background: #DC143C; color:white; border: 2px solid red; padding:10px; font-size: 1.1vw; height: 40px;");
	operation.appendChild(d3);
...
function displayneed(){
	...
	h.setAttribute("style","text-align: center,font-family: Segoe UI;");
